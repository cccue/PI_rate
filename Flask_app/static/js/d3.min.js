!function() {
    ...
    function _t(n, t, r) {
        ...
        return (i = uc.get(n)) ? t(i.r, i.g, i.b) : (null  == n || "#" !== n.charAt(0) || isNaN(i = parseInt(n.substring(1), 16)) || (4 === n.length ? (o = (3840 & i) >> 4,
        o = o >> 4 | o,
        a = 240 & i,
        a = a >> 4 | a,
        c = 15 & i,
    ...
    function Ct(n, t, r, e) {
        ...
        var i = {}
          ...
          , l = null ;
        return !fa.XDomainRequest || "withCredentials" in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest),
    ...
    function qt() {
        var n = Tt()
          , t = zt() - n;
        t > 24 ? (isFinite(t) && (clearTimeout(cc),
        cc = setTimeout(qt, t)),
        ac = 0) : (ac = 1,
        sc(qt))
    }
    function Tt() {
        var n = Date.now();
        for (lc = ic; lc; )
            n >= lc.t && (lc.f = lc.c(n - lc.t)),
            lc = lc.n;
        return n
    }
    function zt() {
        for (var n, t = ic, r = 1 / 0; t; )
            t.f ? t = n ? n.n = t.n : ic = t.n : (t.t < r && (r = t.t),
            t = (n = t).n);
        return oc = n,
        r
    }
    ...
    function Ht(n, t, r) {
        ...
        function u(r) {
            return t(r = n(new vc(r - 1)), 1),
            r
        }
        function i(n, r) {
            return t(n = new vc(+n), r),
            n
        }
        function o(n, e, i) {
            var o = u(n)
    ...
    function Ot(n) {
        ...
        function i(n, t, r) {
            ...
            return e ? (n.m = N.get(e[0].toLowerCase()),
            r + e[0].length) : -1
        }
        function o(n, t, r) {
            S.lastIndex = 0;
    ...
    function Lr(n, t, r, e, u) {
        ...
        qr(o),
        i.length) {
            for (var a = 0, c = r, l = o.length; l > a; ++a)
                o[a].e = c = !c;
            for (var s, f, h = i[0]; ; ) {
                for (var g = h, p = !0; g.v; )
                    if ((g = g.n) === h)
        ...
        return function(i, o) {
            ...
            var p, v, d, m = t(o), y = i.invert(e[0], e[1]), x = {
                ...
                polygonEnd: function() {
                    ...
                    p = oa.merge(p);
                    var n = Ur(y, v);
                    p.length ? Lr(p, u, n, r, o) : n && (o.lineStart(),
                    r(null , null , 1, o),
                    o.lineEnd()),
                    o.polygonEnd(),
                    p = v = null 
            ...
            if (s)
                for (var f = l[0], h = f[0], g = f[1] / 2 + Ua / 4, p = Math.sin(g), v = Math.cos(g), d = 1; ; ) {
                    ...
                    var m = n[0]
                      ...
                      , S = w > Ua
                      , k = p * x;
                    if (kc.add(Math.atan2(k * b * Math.sin(w), v * M + k * Math.cos(w))),
                    i += S ? _ + b * ja : _,
                    S ^ h >= r ^ m >= r) {
                        var E = dr(pr(f), pr(n));
                        xr(E);
    ...
    function jr(n) {
        ...
        return {
            ...
            point: function(i, o) {
                var a = i > 0 ? Ua - Fa : -Ua
                  , c = Ma(i - r);
                Ma(c - Ua) < Fa ? (n.point(r, e = (e + o) / 2 > 0 ? Ha : -Ha),
                n.point(u, e),
                n.lineEnd(),
                n.lineStart(),
                n.point(a, e),
                n.point(i, e),
                t = 0) : u !== a && c >= Ua && (Ma(r - u) < Fa && (r -= u * Fa),
                Ma(i - a) < Fa && (i -= a * Fa),
                e = Hr(r, e, i, o),
                n.point(u, e),
                n.lineEnd(),
    ...
    function Ir(n) {
        ...
        function r(n) {
            ...
            return {
                ...
                point: function(f, h) {
                    ...
                    if (!r && (l = c = v) && n.lineStart(),
                    v !== c && (g = e(r, p),
                    (br(r, g) || br(p, g)) && (p[0] += Fa,
                    p[1] += Fa,
                    v = t(p[0], p[1]))),
                    v !== c)
                        s = 0,
        ...
        function e(n, t, r) {
            ...
            if (!(0 > x)) {
                ...
                k = E,
                E = b),
                C ? A ? k + E > 0 ^ _[1] < (Ma(_[0] - w) < Fa ? k : E) : k <= _[1] && _[1] <= E : N > Ua ^ (w <= _[0] && _[0] <= S)) {
                    var L = yr(d, (-m + M) / y);
                    return mr(L, p),
                    [_, _r(L)]
                }
            ...
            function c(n) {
                for (var t = 0, r = d.length, e = n[1], u = 0; r > u; ++u)
                    for (var i, o = 1, a = d[u], c = a.length, l = a[0]; c > o; ++o)
                        i = a[o],
                        l[1] <= e ? i[1] > e && J(l, i, n) > 0 && ++t : i[1] <= e && J(l, i, n) < 0 && --t,
                        l = i;
                return 0 !== t
            }
            function l(i, a, c, l) {
    ...
    function $r(n, t) {
        ...
        var e = vr(r, n.fromNormal)
          ...
          , i = vr(r, t.fromNormal)
          , o = vr(r, t.toNormal);
        return e > -Oa && Oa > u && i > -Oa && Oa > o ? r : Oa > e && u > -Oa && Oa > i && o > -Oa ? (r[0] = -r[0],
        r[1] = -r[1],
        r[2] = -r[2],
        r) : void 0
    }
                    ...
                    if (r) {
                        for (var p = new Vr(r,h), v = [], d = 0, m = 100; d < u.length && m > 0; ++d) {
                            ...
                            if (x) {
                                if (x === Oc || Mr(x, r) || Mr(x, h) || Mr(x, y.from) || Mr(x, y.to)) {
                                    var M = 1e-4;
                                    l = (l + 3 * Ua + (Math.random() < .5 ? M : -M)) % (2 * Ua) - Ua,
                                    s = Math.min(Ua / 2 - 1e-4, Math.max(1e-4 - Ua / 2, s + (Math.random() < .5 ? M : -M))),
                                    p = new Vr(r,h = pr([l, s])),
                                    d = -1,
                                    --m,
                                    v.length = 0;
                        ...
                        if (v.length) {
                            ...
                            for (var d = 0; d < v.length; ++d) {
                                var x = v[d];
                                (g = !g) ? (n.lineStart(),
                                n.point(x[0], x[1], x.index, x.t)) : (n.point(x[0], x[1], x.index, x.t),
                                n.lineEnd())
                            }
                        }
                        g && n.point(l, s)
        ...
        function u(t, r, e, a, c, l, s, f, h, g, p, v, d, m) {
            ...
            if (M > 4 * i && d--) {
                var _ = a + g
                  ...
                  , q = C - r
                  , T = x * L - y * q;
                (T * T / M > i || Ma((y * L + x * q) / M - .5) > .3 || o > a * g + c * p + l * v) && (u(t, r, e, a, c, l, A, C, E, _ /= S, b /= S, w, d, m),
                m.point(A, C),
    ...
    function pe(n) {
        ...
        t.clipPolygon = function(n) {
            return arguments.length ? (b = null ,
            w = n,
            M = null  == n ? Hc : Br(n),
            e()) : w
        }
    ...
    function xe(n) {
        return function(t, r) {
            return t += n,
            [t > Ua ? t - ja : -Ua > t ? t + ja : t, r]
        }
    }
    function Me(n) {
        var t = xe(n);
        return t.invert = xe(-n),
        t
    }
    function _e(n, t) {
        function r(n, t) {
    ...
    function Ce() {
        function n(n, u) {
            var i = Math.sin(u *= Ia)
              ...
              , a = Ma((n *= Ia) - t)
              , c = Math.cos(a);
            Gc += Math.atan2(Math.sqrt((a = o * Math.sin(a)) * a + (a = e * i - r * o * c) * a), r * i + e * o * c),
            t = n,
            r = i,
            e = o
        }
    ...
    function $e(n) {
        var t = n.circle
          ...
          , a = [n];
        Ve(n);
        for (var c = i; c.circle && Ma(r - c.circle.x) < Fa && Ma(e - c.circle.cy) < Fa; )
            i = c.P,
            a.unshift(c),
            Ve(c),
            c = i;
        a.unshift(c),
        tu(c);
        for (var l = o; l.circle && Ma(r - l.circle.x) < Fa && Ma(e - l.circle.cy) < Fa; )
            o = l.N,
            a.push(l),
            Ve(l),
            l = o;
    ...
    function Xe(n) {
        ...
        t || r) {
            if (t === r)
                ...
                void 0;
            if (!r)
                return c.edge = iu(t.site, c.site),
                void 0;
            tu(t),
            tu(r);
            var l = t.site
        ...
        for (var t, r, e, u, i, o, a, c, l, s, f = n[0][0], h = n[1][0], g = n[0][1], p = n[1][1], v = ol, d = v.length; d--; )
            ...
            i && i.prepare())
                ...
                o = 0; c > o; )
                    ...
                    t = l.x,
                    r = l.y,
                    (Ma(e - t) > Fa || Ma(u - r) > Fa) && (a.splice(o, 0, new cu(ou(i.site, s, Ma(e - f) < Fa && p - u > Fa ? {
                        x: f,
                        y: Ma(t - f) < Fa ? r : p
                    } : Ma(u - p) < Fa && h - e > Fa ? {
                        x: Ma(r - p) < Fa ? t : h,
    ...
    function ru(n) {
        for (var t, r = il, e = Yr(n[0][0], n[0][1], n[1][0], n[1][1]), u = r.length; u--; )
            t = r[u],
            (!eu(t, n) || !e(t) || Ma(t.a.x - t.b.x) < Fa && Ma(t.a.y - t.b.y) < Fa) && (t.a = t.b = null ,
            r.splice(u, 1))
    }
    function eu(n, t) {
        var r = n.b;
    ...
    function pu(n, t) {
        ...
        for (il = [],
        ol = new Array(n.length),
        al = new lu,
        ll = new lu; ; )
            if (u = cl,
            i && (!u || i.y < u.y || i.y === u.y && i.x < u.x))
                (i.x !== r || i.y !== e) && (ol[i.i] = new We(i),
                Xe(i),
                r = i.x,
                e = i.y),
                i = n.pop();
    ...
    function Su(n, t) {
        ...
        i = s.length; (r = gl.exec(n)) && i > e; ++e)
            ...
            o.x == r[0]) {
                ...
                o.x = wu(parseFloat(r[0]), parseFloat(o.x));
        for (; i > e; )
            o = s.pop(),
    ...
    function Uu(n, t) {
        ...
        arguments.length ? r = t / ja * Math.asin(1 / n) : (n = 1,
        r = t / 4),
        function(e) {
    ...
    function Zu(n) {
        ...
        e *= -1,
        u *= -1),
        this.rotate = (e ? Math.atan2(t[1], t[0]) : Math.atan2(-r[0], r[1])) * Ya,
    ...
    function Qu(n, t) {
        if (n === t)
            return n;
        for (var r = Ku(n), e = Ku(t), u = r.pop(), i = e.pop(), o = null ; u === i; )
            o = u,
            u = r.pop(),
            i = e.pop();
        return o
        ...
        if ((r = n.children) && (l = r.length)) {
            ...
            l > 2))
                ...
                o = 3; l > o; o++) {
                    ...
                    if (1 == p)
                        for (c = e._pack_prev; c !== a._pack_prev && !Di(c, i); c = c._pack_prev,
                        d++)
                            ;
                    p ? (d > v || v == d && u.r < e.r ? Ri(e, u = a) : Ri(e = c, u),
                    o--) : (zi(e, i),
                    u = i,
                    t(i))
                }
    ...
    function co(n, t, r) {
        ...
        e.exponent = function(o) {
            return arguments.length ? (u = lo(t = o),
            i = lo(1 / t),
            n.domain(r.map(u)),
            e) : t
        }
    ...
    function so(n, t) {
        ...
        r.rangePoints = function(u, o) {
            ...
            return i = e(n.length < 2 ? (c + l) / 2 : c + s * o / 2, s),
            a = 0,
            t = {
                t: "rangePoints",
                a: arguments
    ...
    function Mo(n) {
        function t(t) {
            ...
            for (var c, l = [], s = [], f = -1, h = t.length, g = Et(r), p = Et(e); ++f < h; )
        ...
        t.interpolate = function(n) {
            return arguments.length ? (o = "function" == typeof n ? i = n : (i = Rl.get(n) || _o).key,
            t) : o
        }
        ,
    ...
    function No(n, t) {
        return n.length < 3 ? _o(n) : n[0] + Co((n.push(n[0]),
        n), Lo([n[n.length - 2]].concat(n, [n[1]]), t))
    }
    function Ao(n, t) {
    ...
    function Ro(n, t) {
        var r = n.length - 1;
        if (r)
            for (var e, u, i = n[0][0], o = n[0][1], a = n[r][0] - i, c = n[r][1] - o, l = -1; ++l <= r; )
                e = n[l],
                u = l / r,
                e[0] = t * e[0] + (1 - t) * (i + u * a),
                e[1] = t * e[1] + (1 - t) * (o + u * c);
    ...
    function jo(n) {
        for (var t = 0, r = n.length - 1, e = [], u = n[0], i = n[1], o = e[0] = Uo(u, i); ++t < r; )
    ...
    function Io(n) {
        ...
        ,
        t.interpolate = function(n) {
            return arguments.length ? (c = "function" == typeof n ? a = n : (a = Rl.get(n) || _o).key,
            l = a.reverse || a,
            s = a.closed ? "M" : "L",
            t) : c
        }
    ...
    oa.median = function(r, e) {
        ...
        r = r.filter(t),
        r.length ? oa.quantile(r.sort(n), .5) : void 0
    }
    ;
    var xa = r(n);
    ...
    La.selectAll = function(n) {
        ...
        for (var u = -1, i = this.length; ++u < i; )
            for (var o = this[u], a = -1, c = o.length; ++a < c; )
                (r = o[a]) && (e.push(t = ca(n.call(r, r.__data__, a, u))),
                t.parentNode = r);
        return _(e)
    }
    ;
    ...
    Ta.select = function(n) {
        for (var t, r, e, u, i, o = [], a = -1, c = this.length; ++a < c; ) {
            ...
            for (var l = -1, s = u.length; ++l < s; )
                (i = u[l]) ? (t.push(e[l] = r = n.call(u.parentNode, i.__data__, l, a)),
    ...
    oa.behavior.zoom = function() {
        ...
        function s() {
            ...
            function i() {
                for (var n, t, r, i, o = oa.touches(g), c = 0, l = o.length; l > c; ++c,
                i = null )
                    if (r = o[c],
                    i = v[r.identifier]) {
                        if (t)
            ...
            function f() {
                if (oa.event.touches.length) {
                    for (var t = oa.event.changedTouches, r = 0, e = t.length; e > r; ++r)
        ...
        function g() {
            ...
            o(n),
            e(Math.pow(2, oa.event.shiftKey ? Math.ceil(l) - 1 : Math.floor(l) + 1)),
            u(r, i),
            a(n),
            c(n)
        }
        ...
        n.scaleExtent = function(t) {
            return arguments.length ? (E = null  == t ? Ba : [+t[0], +t[1]],
            n) : E
        }
        ,
        n.center = function(t) {
        ...
        r.parseRows = function(n, t) {
            function r() {
                ...
                if (34 === n.charCodeAt(t)) {
                    ...
                    return 13 === e ? (u = !0,
                    10 === n.charCodeAt(r + 2) && ++s) : 10 === e && (u = !0),
                ...
                for (; l > s; ) {
                    ...
                    if (10 === e)
                        ...
                        continue;return n.substring(t, s - a)
                }
    ...
    ["sunday", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday"].forEach(function(n, t) {
        ...
        var r = pc[n] = Ht(function(n) {
            return (n = pc.day(n)).setDate(n.getDate() - (n.getDay() + t) % 7),
            n
        }, function(n, t) {
        ...
        return function(n) {
            ...
            if (t) {
                ...
                for (var r, e = 1, u = x[0], i = [u]; t > e; ++e)
                    r = x[e],
                    l(r[0], u) || l(r[1], u) ? (a(u[0], r[1]) > a(u[0], u[1]) && (u[1] = r[1]),
    ...
    oa.geo.centroid = function(n) {
        ...
        e = qc),
        u = t * t + r * r + e * e,
        Oa > u) ? [0 / 0, 0 / 0] : [Math.atan2(r, t) * Ya, G(e / Math.sqrt(u)) * Ya]
    }
    ;
    ...
    oa.geo.clipExtent = function() {
        var n, t, r, e, u, i, o = {
            ...
            extent: function(a) {
                return arguments.length ? (i = Zr(n = +a[0][0], t = +a[0][1], r = +a[1][0], e = +a[1][1]),
                u && (u.valid = !1,
                u = null ),
                o) : [[n, t], [r, e]]
            }
    ...
    oa.geo.albersUsa = function() {
        ...
        n.translate = function(t) {
            ...
            var l = i.scale()
              , s = +t[0]
              , f = +t[1];
            return r = i.translate(t).clipExtent([[s - .455 * l, f - .238 * l], [s + .455 * l, f + .238 * l]]).stream(c).point,
            e = o.translate([s - .307 * l, f + .201 * l]).clipExtent([[s - .425 * l + Fa, f + .12 * l + Fa], [s - .214 * l - Fa, f + .234 * l - Fa]]).stream(c).point,
            u = a.translate([s - .205 * l, f + .212 * l]).clipExtent([[s - .214 * l + Fa, f + .166 * l + Fa], [s - .115 * l - Fa, f + .234 * l - Fa]]).stream(c).point,
            n
        }
        ,
        n.scale(1070)
    ...
    var Ic, Yc, Zc, Vc, $c, Xc, Bc = {
        ...
        polygonEnd: function() {
            Bc.lineStart = Bc.lineEnd = Bc.point = v,
            Ic += Ma(Yc / 2)
        }
    }, Jc = {
        point: te,
    ...
    oa.geo.path = function() {
        ...
        return n.area = function(n) {
            return Ic = 0,
            oa.geo.stream(n, u(Bc)),
            Ic
        }
        ,
        n.centroid = function(n) {
            return Cc = Lc = qc = Tc = zc = Rc = Dc = Pc = Uc = 0,
            oa.geo.stream(n, u(Wc)),
            Uc ? [Dc / Uc, Pc / Uc] : Rc ? [Tc / Rc, zc / Rc] : qc ? [Cc / qc, Lc / qc] : [0 / 0, 0 / 0]
        }
        ,
        n.bounds = function(n) {
            return $c = Xc = -(Zc = Vc = 1 / 0),
            oa.geo.stream(n, u(Jc)),
            [[Zc, Vc], [$c, Xc]]
        }
        ,
        n.projection = function(n) {
            return arguments.length ? (u = (r = n) ? n.stream || se(n) : Nt,
            t()) : r
        }
        ,
        n.context = function(n) {
            return arguments.length ? (i = null  == (e = n) ? new re : new ce(n),
    ...
    oa.geo.rotation = function(n) {
        ...
        return n = ye(n[0] % 360 * Ia, n[1] * Ia, n.length > 2 ? n[2] * Ia : 0),
        t.invert = function(t) {
    ...
    oa.geo.circle = function() {
        ...
        ,
        n.angle = function(e) {
            return arguments.length ? (r = be((t = +e) * Ia, u * Ia),
            n) : t
        }
        ,
        n.precision = function(e) {
            return arguments.length ? (r = be(t * Ia, (u = +e) * Ia),
            n) : u
        }
        ,
        n.angle(90)
    ...
    ul.clip = function(n) {
        for (var t, r, e, u, i, o, a = Ie(n), c = -1, l = this.length - Ie(this), s = this[l - 1]; ++c < l; ) {
            ...
            r = -1; ++r < e; )
                o = t[r],
                Fe(o, s, u) ? (Fe(i, s, u) || n.push(Oe(i, o, s, u)),
                n.push(o)) : Fe(i, s, u) && n.push(Oe(i, o, s, u)),
                i = o;
            a && n.push(n[0]),
            s = u
        }
    ...
    oa.geom.voronoi = function(n) {
        ...
        t.triangles = function(n) {
            ...
            return pu(r(n)).cells.forEach(function(r, e) {
                for (var u, i, o = r.site, a = r.edges.sort(Ke), c = -1, l = a.length, s = a[l - 1].edge, f = s.l === o ? s.r : s.l; ++c < l; )
                    u = s,
                    i = f,
                    s = a[c].edge,
                    f = s.l === o ? s.r : s.l,
                    e < i.i && e < f.i && du(o, i, f) < 0 && t.push([n[e], n[i.i], n[f.i]])
            }),
            t
        }
        ,
        ...
        ,
        t.clipExtent = function(n) {
            return arguments.length ? (a = null  == n ? hl : n,
            t) : a === hl ? null  : a
        }
        ,
        t.size = function(n) {
    ...
    oa.geom.quadtree = function(n, t, r, e, u) {
        ...
        var o, a = Pe, c = Ue;
        return (o = arguments.length) ? (a = mu,
        c = yu,
        3 === o && (u = r,
        e = t,
        r = t = 0),
    ...
    oa.layout.force = function() {
        ...
        return a.tick = function() {
            ...
            d))
                for (; ++r < _; )
                    ...
                    a.y += (M - a.y) * d;
            if (g)
                for (ui(t = oa.geom.quadtree(m), e, o),
                r = -1; ++r < _; )
        ...
        ,
        a.drag = function() {
            return r || (r = oa.behavior.drag().origin(Nt).on("dragstart.force", ni).on("drag.force", t).on("dragend.force", ti)),
            arguments.length ? (this.on("mouseover.force", ri).on("mouseout.force", ei).call(r),
            void 0) : r
        }
        ,
        oa.rebind(a, c, "on")
    ...
    oa.layout.hierarchy = function() {
        function n(t, o, a) {
            ...
            a.push(t),
            c && (l = c.length)) {
                for (var l, s, f = -1, h = t.children = new Array(l), g = 0, p = o + 1; ++f < l; )
                    s = h[f] = n(c[f], p, a),
                    s.parent = t,
                    g += s.value;
                e && h.sort(e),
    ...
    oa.layout.stack = function() {
        function n(a, c) {
            ...
            for (g = 0; m > g; ++g)
                for (u.call(n, l[0][g], p = v[g], s[0][g][1]),
                h = 1; d > h; ++h)
        ...
        ,
        n.order = function(t) {
            return arguments.length ? (r = "function" == typeof t ? t : bl.get(t) || gi,
            n) : r
        }
        ,
        n.offset = function(t) {
            return arguments.length ? (e = "function" == typeof t ? t : wl.get(t) || pi,
            n) : e
        }
        ,
        n.x = function(t) {
    ...
    oa.layout.histogram = function() {
        function n(n, i) {
            for (var o, a, c = [], l = n.map(r, this), s = e.call(this, l, i), f = u.call(this, s, l, i), i = -1, h = l.length, g = f.length - 1, p = t ? 1 : 1 / h; ++i < g; )
                o = c[i] = [],
                o.dx = f[i + 1] - (o.x = f[i]),
                o.y = 0;
            if (g > 0)
                for (i = -1; ++i < h; )
                    a = l[i],
                    a >= s[0] && a <= s[1] && (o = c[oa.bisect(f, a, 1, g) - 1],
                    o.y += p,
                    o.push(n[i]));
            return c
        }
        ...
        function n(n, i) {
            function o(n, t) {
                ...
                if (e && (i = e.length)) {
                    ...
                    t ? (u.prelim = t._tree.prelim + r(n, t),
            ...
            function a(n, t) {
                ...
                if (r && (e = r.length)) {
                    var e, u = -1;
                    for (t += n._tree.mod; ++u < e; )
                        a(r[u], t)
                }
            }
            function c(n, t, e) {
                if (t) {
                    for (var u, i = n, o = n, a = t, c = n.parent.children[0], l = i._tree.mod, s = o._tree.mod, f = a._tree.mod, h = c._tree.mod; a = wi(a),
                    i = bi(i),
                    a && i; )
                        c = bi(c),
                        o = wi(o),
                        ...
                        h += c._tree.mod,
                        s += o._tree.mod;
                    a && !wi(o) && (o._tree.thread = a,
                    o._tree.mod += f - s),
                    i && !bi(c) && (c._tree.thread = i,
                    c._tree.mod += l - h,
                    e = n)
                }
                return e
    ...
    oa.layout.pack = function() {
        function n(n, i) {
            ...
            return Hi(a, c / 2, l / 2, t ? 1 : 1 / Math.max(2 * a.r / c, 2 * a.r / l)),
            o
        }
    ...
    oa.layout.treemap = function() {
        ...
        function t(r) {
            ...
            if (i && i.length) {
                ...
                for (n(h, l.dx * l.dy / r.value),
                s.area = 0; (c = h.length) > 0; )
                    s.push(o = h[c - 1]),
                    s.area += o.area,
                    "squarify" !== g || (a = e(s, v)) <= p ? (h.pop(),
        ...
        i.padding = function(n) {
            ...
            if (!arguments.length)
                return s;
            var e;
            return f = null  == (s = n) ? Vi : "function" == (e = typeof n) ? t : "number" === e ? (n = [n, n, n, n],
            r) : r,
            i
        }
        ,
    ...
    Yl.select = function(n) {
        ...
        for (var o = -1, a = this.length; ++o < a; ) {
            ...
            for (var c = this[o], l = -1, s = c.length; ++l < s; )
                (e = c[l]) && (r = n.call(e, e.__data__, l, o)) ? ("__data__" in e && (r.__data__ = e.__data__),
    ...
    Yl.ease = function(n) {
        var t = this.id;
        return arguments.length < 1 ? this.node().__transition__[t].ease : ("function" != typeof n && (n = oa.ease.apply(oa, arguments)),
        P(this, function(r) {
    ...
    Yl.transition = function() {
        for (var n, t, r, e, u = this.id, i = ++Zl, o = [], a = 0, c = this.length; c > a; a++) {
            ...
            for (var t = this[a], l = 0, s = t.length; s > l; l++)
                (r = t[l]) && (e = Object.create(r.__transition__[u]),
                e.delay += e.duration,
                Ko(r, l, i, e)),
                n.push(r)
        }
    ...
    oa.svg.axis = function() {
        function n(n) {
            n.each(function() {
                var n, l = oa.select(this), s = this.__chart__ || r, f = this.__chart__ = r.copy(), h = null  == c ? f.ticks ? f.ticks.apply(f, a) : f.domain() : c, g = null  == t ? f.tickFormat ? f.tickFormat.apply(f, a) : Nt : t, p = l.selectAll(".tick").data(h, f), v = p.enter().insert("g", ".domain").attr("class", "tick").style("opacity", Fa), d = oa.transition(p.exit()).style("opacity", Fa).remove(), m = oa.transition(p.order()).style("opacity", 1), y = Bi(f), x = l.selectAll(".domain").data([0]), M = (x.enter().append("path").attr("class", "domain"),
                oa.transition(x));
                v.append("line"),
                v.append("text");
                var _ = v.select("line")
        ...
        ,
        n.orient = function(t) {
            return arguments.length ? (e = t in $l ? t + "" : Vl,
            n) : e
        }
        ,
        n.ticks = function() {
    ...
    oa.svg.brush = function() {
        ...
        function u() {
            ...
            function p() {
                32 == oa.event.keyCode && 2 == A && (L[0] += s[1],
                L[1] += f[1],
                A = 0,
                y())
            }
            function v() {
                ...
                M && (n[0] += M[0],
                n[1] += M[1]),
                A || (oa.event.altKey ? (x || (x = [(s[0] + s[1]) / 2, (f[0] + f[1]) / 2]),
                L[0] = s[+(n[0] < x[0])],
            ...
            function d(n, t, r) {
                ...
                A ? u = (e += p) + d : (x && (p = Math.max(c, Math.min(l, 2 * x[r] - e))),
                e > p ? (u = e,
                e = p) : u = p),
            ...
            if (oa.event.changedTouches ? q.on("touchmove.brush", v).on("touchend.brush", m) : q.on("mousemove.brush", v).on("mouseup.brush", m),
            ...
            A)
                ...
                var T = +/w$/.test(k)
                  , z = +/^n/.test(k);
                M = [s[1 - T] - L[0], f[1 - z] - L[1]],
                L[0] = s[T],
                L[1] = f[z]
            } else
                oa.event.altKey && (x = L.slice());
    ...
    Jl.iso = Date.prototype.toISOString && +new Date("2000-01-01T00:00:00.000Z") ? ta : Gl,
    ta.parse = function(n) {
        var t = new Date(n);
    ...
    var Kl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6]
      , Ql = [[pc.second, 1], [pc.second, 5], [pc.second, 15], [pc.second, 30], [pc.minute, 1], [pc.minute, 5], [pc.minute, 15], [pc.minute, 30], [pc.hour, 1], [pc.hour, 3], [pc.hour, 6], [pc.hour, 12], [pc.day, 1], [pc.day, 2], [pc.week, 1], [pc.month, 1], [pc.month, 3], [pc.year, 1]]
      , ns = Jl.multi([[".%L", function(n) {
